...
and uint32(17) - 323157430 == 1412131772 
and hash.crc32(8, 2) == 0x61089c5c 
and filesize ^ uint8(77) != 22 
and uint8(75) % 24 < 24 
and uint8(66) < 133 
and uint8(21) % 11 < 11 
and uint8(46) < 154 
and hash.crc32(34, 2) == 0x5888fc1b 
and uint8(55) > 5 
and uint8(36) + 4 == 72 
...
and uint8(43) > 24 
and uint8(82) < 152 
and uint32(59) ^ 512952669 == 1908304943 
...
and uint32(28) - 419186860 == 959764852 
and uint8(74) + 11 == 116 
and uint8(48) < 136 
and uint8(47) < 142 
and hash.crc32(63, 2) == 0x66715919 
and uint8(58) < 146 
...
and uint8(19) % 30 < 30 
and hash.sha256(14, 2) == "403d5f23d149670348b147a15eeb7010914701a7e99aad2e43f90cfa0325c76f" 
...
and uint8(20) % 28 < 28 
and uint8(30) & 128 == 0 
and uint32(66) ^ 310886682 == 849718389 
and uint8(64) % 24 < 24 
and uint32(10) + 383041523 == 2448764514 
and uint8(79) & 128 == 0 
...
and uint8(64) > 27 
and uint32(37) + 367943707 == 1228527996 
and uint8(82) % 28 < 28 
and uint8(32) > 28 
and filesize ^ uint8(24) != 217 
and uint8(53) < 144 
and uint8(29) & 128 == 0 
and uint32(22) ^ 372102464 == 1879700858 
and uint8(52) % 23 < 23 
...
and uint32(46) - 412326611 == 1503714457 
and uint8(11) % 27 < 27 
and hash.crc32(78, 2) == 0x7cab8d64 
and uint8(83) & 128 == 0 
...
and uint8(28) > 27 
and uint32(70) + 349203301 == 2034162376 
...
and uint8(22) & 128 == 0 
and uint8(82) & 128 == 0 
and uint32(80) - 473886976 == 69677856 
and uint8(75) > 30 
and uint8(32) % 17 < 17 
...
and uint8(46) & 128 == 0 
and uint8(24) % 26 < 26 
and uint32(3) ^ 298697263 == 2108416586 
and uint8(21) - 21 == 94 
and uint8(67) < 144 
and uint8(48) > 15 
and uint8(37) > 16 
...
and uint32(41) + 404880684 == 1699114335 
